...
import com.greatlearning.Service.LinearSearchImplementation;
...
public class Driver {
	...
	public static void main(String[] args) {
		...
		LinearSearchImplementation linearSearch = new LinearSearchImplementation();
		
		System.out.println("Enter the no of Companies: ");
		numberOfCompanies = sc.nextInt();
		boolean status;
		int profitCompanies=0;
		int lossCompanies=0;
